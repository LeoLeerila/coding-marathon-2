    ...
    return (
        <div className="create">
            ...
            <form className='text-center flex flex-col align-middle justify-center items-center h-full'>
                ...
                <input className="border roundedl py-2 px-3" type="text" required value={name} onChange={(e) => setName(e.target.value)} />
                <label className="block text-gray-700 font-bold mb-2">Email:</label>
                <input className="border rounded py-2 px-3" type="email" required value={email} onChange={(e) => setEmail(e.target.value)} />
                ...
                <input className="border rounded py-2 px-3" type="text" required value={street} onChange={(e) => setStreet(e.target.value)} />
                <label className="block text-gray-700 font-bold mb-2">City:</label>
                <input className="border rounded py-2 px-3" type="text" required value={city} onChange={(e) => setCity(e.target.value)} />
                <label className="block text-gray-700 font-bold mb-2">Zip Code:</label>
                <input className="border rounded py-2 px-3" type="text" required value={zipCode} onChange={(e) => setZipCode(e.target.value)} />
                <button onClick={(e) => {
                    signupUser(e);
